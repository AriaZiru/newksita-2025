...
class FootballMatchPolicy
{
    ...
    {
        return $user->can('view_any_football::match');
    }
    ...
    {
        return $user->can('view_football::match');
    }
    ...
    {
        return $user->can('create_football::match');
    }
    ...
    {
        return $user->can('update_football::match');
    }
    ...
    {
        return $user->can('delete_football::match');
    }
    ...
    {
        return $user->can('delete_any_football::match');
    }
     ...
     */
    public function replicate(User $user, FootballMatch $footballMatch): bool
    {
